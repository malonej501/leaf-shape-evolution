"""For fitting a continuous time Markov chain model of trait evolution to the
simulation data. Requires the data from a full simulation run in WD."""
import os
import shutil
import sys
import warnings
...
from pdict import first_cats  # noqa
